...
- (BOOL)isEqual:(id)object
{
    ...
    SKVideoMediaItem *videoItem = (SKVideoMediaItem *)object;
...
{
    SKVideoMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL
